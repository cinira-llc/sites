export default function Home() {
    return (
        <ul>
            ...
            <li><a href="https://pds.cinira.net/airband/guard.mp3">Emergency/Guard (121.5)</a></li>
            <li><a href="https://pds.cinira.net/airband/nearby.mp3">Nearby CTAFs (122.8, 122.9, 123.0, 123.05)</a></li>
        </ul>
    );
}